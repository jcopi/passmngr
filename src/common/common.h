...
#define COMMON_HASHMAP_ERROR_START  (0x000)
#define COMMON_ARCHIVE_ERROR_START  (0x100)
#define COMMON_VAULT_ERROR_START    (0x200)
#define COMMON_PASSWORD_ERROR_START (0x300)
